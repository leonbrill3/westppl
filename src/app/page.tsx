...
import { WestPplLogo } from "@/components/icons/WestPplLogo";
...
export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          >
            ...
            {/* Eyebrow */}
            <p className="font-caps text-sm text-pink mb-6">
              Invite-Only &bull; Miami &bull; Los Angeles &bull; New York
            </p>

            {/* Tagline */}
            <p className="font-body text-lg lg:text-xl text-white/80 mb-2 max-w-2xl mx-auto">
              An invite-only members community with curated events, member perks,
              concierge, and a private member app — across three cities.
            </p>
            <p className="font-caps text-xs text-white/40 mb-10">
              An elevated home for sizzling souls.
            </p>
      ...
      {/* Join CTA Section */}
      <section className="py-32 px-6 md:px-10 lg:px-16 xl:px-24 relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
